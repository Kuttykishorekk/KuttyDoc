...
def prescribe_medicine(appointment_id):
    ...
    if request.method == 'POST':
        ...
        # Add KuttyDoc header with green color and an <hr> tag
        KuttyDoc_header = Paragraph("<font color='green' size='24'><b>KuttyDoc: We Care for Your Health</b></font><hr/>", header_style)
        content.append(KuttyDoc_header)

        # Add space after KuttyDoc header
        ...
        doctor_details = (
            ...
            "<font size='12'>Thank you for choosing KuttyDoc! We wish you good health.</font>"
        )
